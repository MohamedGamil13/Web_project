...
export function filtersToApiQuery(filters) {
  ...
  if (filters.minPrice !== '' && filters.minPrice != null) q.minPrice = Number(filters.minPrice);
  if (filters.maxPrice !== '' && filters.maxPrice != null) q.maxPrice = Number(filters.maxPrice);
